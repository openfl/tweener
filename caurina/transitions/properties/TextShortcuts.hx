...
//		Tweener.registerSpecialPropertyModifier("_text", _text_modifier, _text_get);
	 ...
	 */
	public static function _text_get (p_obj:TextField, p_parameters:Array<Dynamic>, p_extra:Dynamic = null):Float {
	 ...
	 */
	public static function _text_set (p_obj:TextField, p_value:Float, p_parameters:Array<Dynamic>, p_extra:Dynamic = null): Void {
	...
	public static function _text_preProcess (p_obj:TextField, p_parameters:Array<Dynamic>, p_originalValueComplete:Dynamic, p_extra:Dynamic = null): Float {
	 ...
	 */
	public static function _textFormat_property_get (p_obj:TextField, p_parameters:Array<Dynamic>, p_extra:Dynamic = null):Null<Float> {
