...
class DisplayShortcuts {
	 ...
	 */
	public static function _frame_get (p_obj:MovieClip, p_parameters:Array<Dynamic>, p_extra:Dynamic = null):Float {
	 ...
	 */
	public static function _frame_set (p_obj:MovieClip, p_value:Float, p_parameters:Array<Dynamic>, p_extra:Dynamic = null): Void {
	 ...
	 */
	public static function _autoAlpha_get (p_obj:DisplayObject, p_parameters:Array<Dynamic>, p_extra:Dynamic = null):Float {
		return p_obj.alpha;
	}
	 ...
	 */
	public static function _autoAlpha_set (p_obj:DisplayObject, p_value:Float, p_parameters:Array<Dynamic>, p_extra:Dynamic = null): Void {
		p_obj.alpha = p_value;
	 ...
	 */
	public static function _scrollRect_property_get (p_obj:DisplayObject, p_parameters:Array<Dynamic>, p_extra:Dynamic = null):Float {
		return Reflect.field(p_obj.scrollRect, p_parameters[0]);
	}
	public static function _scrollRect_property_set (p_obj:DisplayObject, p_value:Float, p_parameters:Array<Dynamic>, p_extra:Dynamic = null): Void {
